	...
	<div class="col-lg-12">
				...
				<div class="widget-box">
					...
					<h4>Choose Movie</h4>
						...
						@if(!empty($moviesList))
						<div class="col-md-4">
						  <p>{{Form::label('movies_list', 'Choose Movie to Edit*', array('class'=>'block clearfix'))}}
						  </div>
						  <div class="col-md-8">
							{{Form::select('movies_list', array(''=>'Select Movie')+ $moviesList, array('name' => '$moviesList[movie_title]'))}}
							</div>
							@else
							<div class="col-lg-12">
				...
				@if(!empty($formData))
				{{Form::model($formData, array('url'=>'doupdatemovie', 'name'=>'movie-register-form','id'=>'movie-register-form','files'=>'true'))}}
